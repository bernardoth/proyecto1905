    ...
    <div class="flex  items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom  rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle " role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <div class="py-5 bg-zinc-400 shadow-md shadow-indigo-800/50 px-5">
                <div id ="cabeza" class="text-bold font-lg py-2">Lista de Proveedores</div>
                ...
                <table  class=" table-auto w-80 text-center">
                    ...
                    <tbody id="lista" >
                        ...
                        <tr>
                            <td class="px-5">{{$prov->id}}</td>
                            <td class="px-5">{{$prov->nombres}}</td>
                            <td class="px-5">{{$prov->apellidos}}</td>
                            <td class="px-5">{{$prov->ci}}</td>
                            <td class="px-5">{{$prov->celular}}</td>
                            <td class="px-5">
                                <button wire:click="seleccion({{$prov->id}})"   id="boton" class="bg-green-500  hover:bg-green-700 text-white font-bold py-2 px-6 ">
                                    Seleccionar
                                </button>
                            </td>
                        </tr>
